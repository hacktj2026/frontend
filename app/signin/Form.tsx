...
function Form() {
  ...
  return (
    <div className="flex flex-col gap-y-5 justify-center rounded-lg border-2 border-zinc-800 w-100 m-auto px-5 py-10">
      ...
      <Btn
        ...
        primary
      />
      <div className="my-3 w-full bg-zinc-800 h-0.5 flex items-center justify-center">
